//lista
document.getElementById("omKeresesDiv").innerHTML = `<input type="text" id="szurtOm" maxlength="11" onkeypress="OmEllenoriz()"> <button id="btnKeres" onclick="Betolt(true)">Keres</button> <input type="file" id="inpFile" onchange="readFile(this)">`;
...
function OmEllenoriz() {
    ...
    //     console.log("yes");
    // }
    tanulok = teljesLista.filter(OmEgyezikE);
    console.log(tanulok);
    Betolt(true);
}
